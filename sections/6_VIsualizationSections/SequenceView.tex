...
\yh{The x-axis represents time and the y-axis represent feature importance rank.
...
However, this design leads to serious visual clutter due to link overlap when feature ranks frequently change over time. 

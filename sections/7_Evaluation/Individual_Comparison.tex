...
\QM{Moreover, by hovering on the feature ``$\color{WINDColor}{30\_NE\_Wind}$" in feature importance view(Fig.~\ref{fig:winter_exploration}D$_1$), the corresponding feature is highlighted in the temporal trend view as Fig.~\ref{fig:winter_exploration}E$_1$ shown, which illustrates a weak wind speed.}
